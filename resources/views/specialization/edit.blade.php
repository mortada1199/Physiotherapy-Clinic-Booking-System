                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="form" action="{{ url('updatespetial', $sessions->id) }}"
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" id="numbersession" name="numbersession"
                                                                ...
                                                                value="{{ old('numbersession', $sessions->numbersession) }}">
                                                            @error('numbersession')
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" id="price" name="price"
                                                                ...
                                                                value="{{ old('price', $sessions->price) }}">
                                                            @error('price')
                                                                <small class="form-text text-danger">{{ $message }}</small>
                                                            @enderror
                                                        </div>
