                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="form" action="{{ url('updatedoctor', $doctors->id) }}" method="POST"
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="experience" class="form-control"
                                                                value="{{ old('experience', $doctors->experience) }}"
